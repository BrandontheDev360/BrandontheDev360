...
"partitionBy": {
      "otherEntityInfo.groupHealthPlanName": "$otherEntityInfo.groupHealthPlanName",
      "otherEntityInfo.groupHealthPlanNumber": "$otherEntityInfo.groupHealthPlanNumber",
      "orgId": "$orgId",
      "carrierCode": "$carrierCode"
    },
    "sortBy": { "otherEntityInfo.referenceYear": -1, "updatedDate": -1 },
    "output": {
      "maxReferenceYear": {
        "$max": "$otherEntityInfo.referenceYear",
